<section class="animate__animated animate__fadeIn">
                            <p class="page-title">
                                <span>static ad banner</span>
                            </p>
                            <form id="staticadbannersform">
                                <div class="flex flex-col space-y-3 bg-white/90 p-5 xl:p-10 rounded-sm">
                                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                                        ...
                                        <div class="form-group">
                                            <label for="textone" class="control-label">text one</label>
                                            <input type="text" name="textone" id="textone" class="form-control">
                                        </div>  
                                        <div class="form-group">
                                            <label for="texttwo" class="control-label">text two</label>
                                            <input type="text" name="texttwo" id="texttwo" class="form-control">
                                        </div>  
                                        <div class="form-group">
                                            <label for="textthree" class="control-label">text three</label>
                                            <input type="text" name="textthree" id="textthree" class="form-control">
                                        </div>  
