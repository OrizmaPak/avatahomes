    <section class="h-full overflow-y-auto org-theme">
        <style>.org-theme .edit-icon {
    position: absolute;
    bottom: 10px;
    right: 10px;
...
.org-theme .edit-icon:hover {
    background-color: #b8860b;
}

.org-theme .\!text-blue-600,
.org-theme .text-blue-500 {
    color: #b8860b !important;
}

.org-theme .\!border-blue-600 {
    border-color: #c89a2b !important;
}

.org-theme #settings_defaultaccounts:hover {
    color: #7a6332 !important;
    border-color: #e3c77e !important;
}
...
.org-theme .border-b {
    border-color: #efe1bc !important;
}

.org-theme #submit.btn {
    background-image: linear-gradient(135deg, #e4c265, #c89a2b);
}

.org-theme .form-group-auth input:focus,
.org-theme .form-group-auth select:focus,
.org-theme .form-group-auth textarea:focus {
    border-color: #c89a2b !important;
        ...
        <input type="file" id="fileInput" accept="image/*" style="display: none;" onchange="updateImage(event)">
            ...
            <form class="mt-10" id="settingsform" autocomplete="of">
                    ...
                    <div class="flex justify-end items-center mt-10">
                        ...
                        <!--<button id="submit" type="button" class="w-full md:w-max rounded-full text-white text-sm capitalize bg-gradient-to-tr from-blue-400 via-blue-500 to-primary-g px-8  py-3 lg:py-2shadow-md font-medium hover:opacity-75 transition duration-300 ease-in-out flex items-center justify-center gap-3">-->
                        <!--    <div class="btnloader" style="display: none;" ></div>-->
                        <!--    <span>Update</span>-->
                        <!--</button>-->
                    </div>
