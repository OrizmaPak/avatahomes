                            ...
                            <form id="socialmedialinkssform">
                                <div class="flex flex-col space-y-3 bg-white/90 p-5 xl:p-10 rounded-sm">
                                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                                        ...
                                        <div class="form-group">
                                            <label for="socialmedianame" class="control-label">social media name</label>
                                            <input type="text" name="socialmedianame" id="socialmedianame" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="url" class="control-label">URL</label>
                                            <!--<div id="imagePreview"></div>-->
                                            <!--<input type="text" name="url" id="url" class="form-control" onchange="previewImage('url')">-->
