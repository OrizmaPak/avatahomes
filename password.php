...
<head>
    ...
    <title>Forgot Password | AVATA HOMES</title>
...
<body class="h-screen overflow-hidden  xl:bg-[#fafafa]" >
    ...
    <section>
        <div class="text-primary-g font-heebo font-bold text-base uppercase md:w-2/3 xl:w-1/3 3xl:w-1/5 mx-auto text-center my-10"> 
            Elfri<span class="text-gray-400">que</span>
        </div> 
            ...
            <form class="mt-10" id="passwordform">
                <div>
                    ...
                    <div class="flex gap-3 3xl:gap-1 flex-col md:flex-row items-center mt-10">
                        ...
                        <a href="./login.php" class="w-full md:w-max rounded-full text-gray-600 text-sm capitalize bg-white px-6  py-3 lg:py-2shadow-sm font-medium hover:opacity-75 transition duration-300 ease-in-out flex items-center justify-center gap-3">
