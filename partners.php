                            ...
                            <form id="partnerssform">
                                <div class="flex flex-col space-y-3 bg-white/90 p-5 xl:p-10 rounded-sm">
                                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                                        ...
                                        <div class="form-group">
                                            <label for="partnername" class="control-label">partner name</label>
                                            <input type="text" name="partnername" id="partnername" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="partnerlogo" class="control-label">partner logo</label>
                                            <div id="imagePreview"></div>
                                            <input type="file" name="partnerlogo" id="partnerlogo" class="form-control" onchange="previewImage('partnerlogo')">
                                        </div>  
