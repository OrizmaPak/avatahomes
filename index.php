...
<body class="dashboard-theme"> 
                ...
                <div class="xl:flex h-screen relative">
                    ...
                    <section class="flex-1 flex flex-col justify-between pb-14">
                        ...
                        <footer class="mt-5 p-5 xl:p-0">
                            <p class="xl:w-5/6 3xl:w-3/5 mx-auto py-1 border-t border-gray-200 text-xs text-gray-400"> &copy; <?php echo date('Y'); ?> avatahomes.com
                            </p>
                        </footer>
                    </section>
                </div>
    ...
    <script src="./js/router.js?v=20260617a"></script>
    <script src="./js/index.js?v=20260618a"></script>
