                                ...
                                <div class="flex flex-col space-y-3 bg-white/90 p-5 xl:p-10 rounded-sm">
                                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="bannername" id="bannername" class="form-control">
                                        </div>                                        
                                        <div class="form-group">
                                            <label for="text1" class="control-label">text one</label>
                                            <input type="text" name="text1" id="text1" class="form-control">
                                        </div>  
                                        <div class="form-group">
                                            <label for="text2" class="control-label">text two</label>
                                            <input type="text" name="text2" id="text2" class="form-control">
                                        </div>  
                                        <div class="form-group">
                                            <label for="text3" class="control-label">text three</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" name="url" id="url" class="form-control" onchange="previewImage('url')">
                                        </div>  
